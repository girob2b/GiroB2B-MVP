...
function Sidebar({
  ...
  pathname, navItems, displayName, avatarSrc, avatarFallback,
  ...
  return (
    ...
    >
      ...
      {/* Navegação */}
      <nav className="flex-1 px-2 py-4 space-y-0.5 overflow-y-auto" aria-label="Menu principal">
