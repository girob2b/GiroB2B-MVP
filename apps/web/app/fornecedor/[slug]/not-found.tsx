...
/**
 * not-found para /fornecedor/[slug].
 * Quando o supplier não existe ou está suspenso.
 */
export default function FornecedorNotFound() {
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-4">
      ...
      <p className="text-sm text-slate-500 max-w-sm mb-8">
        Este perfil de vendedor não existe ou não está mais disponível.
        Publique sua demanda e receba contatos de vendedores qualificados.
      </p>
